    ...
    try{
        if(req.method === 'GET'){
            ...
            if(req?.query?.id){
                ...
                // como eu valido se é um usuario valido
                ...
                // agora q ja estamos no feed principal, qual o proximo passo?
                ...
                // agora q ja tenho o usuario, quais dados eu preciso mais?
                // publis de quem o usuario logado segue
